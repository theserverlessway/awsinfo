ENVIRONMENTS=$(awscli elasticbeanstalk describe-environments --output text --query "sort_by(Environments,&EnvironmentName)[$(auto_filter EnvironmentName ApplicationName -- $@)].[EnvironmentName]")
