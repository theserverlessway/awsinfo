PROJECTS=$(awscli codebuild list-projects --output text --query "projects[$(auto_filter @ -- $@)].[@]")
...
BUILD_IDS=$(awscli codebuild list-builds-for-project --project-name $SELECTED --output text --query "ids[].[@]" | head -n 99 )
