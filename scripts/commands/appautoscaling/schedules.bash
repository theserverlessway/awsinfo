...
awscli application-autoscaling describe-scheduled-actions --service-namespace $FIRST_RESOURCE --output table --query "ScheduledActions[$(auto_filter_joined ScalableDimension ResourceId ScheduledActionName Schedule -- $SECOND_RESOURCE)].{
