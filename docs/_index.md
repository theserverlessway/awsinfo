...
* [`autoscaling schedules`](https://github.com/theserverlessway/awsinfo/blob/master/scripts/commands/autoscaling/schedules.md)
* [`backup`](https://github.com/theserverlessway/awsinfo/blob/master/scripts/commands/backup/index.md)
* [`backup backup-jobs`](https://github.com/theserverlessway/awsinfo/blob/master/scripts/commands/backup/backup-jobs.md)
* [`backup copy-jobs`](https://github.com/theserverlessway/awsinfo/blob/master/scripts/commands/backup/copy-jobs.md)
* [`backup report-jobs`](https://github.com/theserverlessway/awsinfo/blob/master/scripts/commands/backup/report-jobs.md)
* [`backup restore-jobs`](https://github.com/theserverlessway/awsinfo/blob/master/scripts/commands/backup/restore-jobs.md)
* [`backup vault`](https://github.com/theserverlessway/awsinfo/blob/master/scripts/commands/backup/vault.md)
...
* [`cloudwatch metric`](https://github.com/theserverlessway/awsinfo/blob/master/scripts/commands/cloudwatch/metric.md)
* [`cloudwatch metrics`](https://github.com/theserverlessway/awsinfo/blob/master/scripts/commands/cloudwatch/metrics.md)
