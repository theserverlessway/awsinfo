...
awscli appsync list-data-sources --api-id $SELECTED --output table --query "sort_by(dataSources,&name)[$(auto_filter name type serviceRoleArn dynamodbConfig.tableName -- $SECOND_RESOURCE)].{
  \"1.Name\":name,
  \"2.Type\":type,
