...
awscli cloudformation list-stack-set-operations --stack-set-name $SELECTED --output table --max-results 20 --query "sort_by(Summaries,&CreationTimestamp)[$(auto_filter OperationId Action Status -- $SECOND_RESOURCE)].{
  \"1.Id\":OperationId,
  \"2.Action\":Action,
  \"3.Status\":Status,
