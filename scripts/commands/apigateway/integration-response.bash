...
awscli apigateway get-integration-response --rest-api-id "$SELECTED_REST_API" --resource-id "$SELECTED" --http-method "$HTTP_REQUEST_METHOD" --status-code "$HTTP_STATUS_CODE" --output table