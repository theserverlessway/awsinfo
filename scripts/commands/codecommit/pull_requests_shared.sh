...
PULL_REQUESTS=$(awscli codecommit list-pull-requests --pull-request-status OPEN --repository-name $SELECTED --output text --query "pullRequestIds[$(auto_filter @ -- $SECOND_RESOURCE)].[@]")
