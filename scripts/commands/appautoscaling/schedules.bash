...
awscli application-autoscaling describe-scheduled-actions --service-namespace $FIRST_RESOURCE --output table --query "ScheduledActions[$(auto_filter ScalableDimension ResourceId ScheduledActionName Schedule -- $SECOND_RESOURCE)].{
