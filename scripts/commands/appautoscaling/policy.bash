...
POLICY_LIST=$(awscli application-autoscaling describe-scaling-policies --service-namespace $FIRST_RESOURCE --output text --query "ScalingPolicies[$(auto_filter ScalableDimension ResourceId PolicyName -- $SECOND_RESOURCE)].[PolicyName]")
